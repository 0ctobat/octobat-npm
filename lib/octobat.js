...
Octobat.DEFAULT_HOST = 'apiv2.octobat.com';
...
var resources = {
  ...
  PaymentRecipients: require('./resources/PaymentRecipients'),
  PaymentRecipientReferences: require('./resources/PaymentRecipientReferences'),
  PaymentSources: require('./resources/PaymentSources'),
  InvoiceNumberingSequences: require('./resources/InvoiceNumberingSequences'),
  CreditNoteNumberingSequences: require('./resources/CreditNoteNumberingSequences'),
  Suppliers: require('./resources/Suppliers'),
  PurchaseItems: require('./resources/PurchaseItems'),
  SelfBillingCreditNotes: require('./resources/SelfBillingCreditNotes'),
  SelfBillingInvoices: require('./resources/SelfBillingInvoices'),
  OutboundTransactions: require('./resources/OutboundTransactions'),
  TaxEvidences: require('./resources/TaxEvidences'),
  TaxEvidenceRequests: require('./resources/TaxEvidenceRequests'),
  Orders: require('./resources/Orders'),
  Beanie: resourceNamespace('beanie', {
    Sessions: require('./resources/Beanie/Sessions'),
  })
};

Octobat.OctobatResource = require('./OctobatResource');
Octobat.resources = resources;
