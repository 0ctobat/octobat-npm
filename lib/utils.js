...
var utils = module.exports = {
  ...
  isOptionsHash: function (o) {
    return _.isPlainObject(o) && _.some(['api_key', 'idempotency_key', 'octobat_account'], function(key) {
  ...
  getOptionsFromArgs: function(args) {
    ...
    if (args.length > 0) {
      ...
      if (utils.isAuthKey(arg)) {
        ...
        if (params.octobat_account) {
          opts.headers['Octobat-Account'] = params.octobat_account;
        }
      }
    }
    return opts;
